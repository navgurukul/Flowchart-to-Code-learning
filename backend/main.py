        ...
        if user_message.lower().startswith("/learn "):
            ...
            if not description:
                ...
                prompt = (
                    ...
                    "RETURN ONLY VALID JSON matching this EXACT schema:\n{\n  \"nodes\": [{\"id\": \"unique_string\", \"type\": \"terminal|process|decision|input|output\", \"label\": \"text\", \"x\": number, \"y\": number}],\n  \"edges\": [{\"id\": \"unique_string\", \"source\": \"node_id\", \"target\": \"node_id\", \"label\": \"optional_text_label\"}],\n  \"problemStatement\": \"clear 1-2 sentence description\",\n  \"inputType\": \"single|multiple|array|object\",\n  \"outputType\": \"number|string|boolean|array|object\",\n  \"sampleInputs\": [\"input1\", \"input2\", \"input3\"],\n  \"sampleOutputs\": [\"output1\", \"output2\", \"output3\"]\n}\n\n"
                    "EDGE CREATION IS CRITICAL:\n"
                    "- Every node that logically flows to another MUST have a corresponding edge in the 'edges' array.\n"
                    "- The 'source' and 'target' fields in each edge object MUST EXACTLY match the 'id' of a node you define in the 'nodes' array.\n"
                    "- For decision nodes, ensure there are distinct edges for different logical paths (e.g., a 'Yes' path and a 'No' path if applicable, using the edge 'label' field for this).\n\n"
